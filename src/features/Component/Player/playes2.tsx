...
export default class PlayerTwo extends React.Component<Props, State> {
    ...
    render() {
        ...
        return (
            <div>
                <div id={selectedPlayer === "player2" ? "player-container-2": "player-inactive"}
                    style={{
                        top: this.state.position[1],
                        left: this.state.position[0],
                        backgroundPosition: '0 0',
                    }}
                    onClick={() => changePlayer("player2")}
                />
            </div>
        );
    }
